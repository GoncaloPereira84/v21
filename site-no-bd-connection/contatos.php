...
<div id="banner">
    ...
    <div class="container">
        ...
        <h1><?php echo translateTo('Contatos'); ?></h1>
    </div>
</div>
            ...
            <div class="container">
                ...
                <div class="form">
                    <form id="contact">
                        ...
                        <div class="form-group full oneline">
                            <label for="contact-phone">Contato: *</label>
                        ...
                        <div class="form-group two-third bottom accept-tc">
                            <label class="check">Confirmo que li e aceito a <a href="/politica-privacidade" target="_blank">Política de Privacidade</a> da Vissaium XXI. 
