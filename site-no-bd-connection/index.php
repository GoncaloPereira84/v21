...
<div id="slideshow">
    <div class="wrapper">
        <div class="slides">
            <div class="slide active right" data-position='right' data-slide-id="1">
                <div class="bg">
                    <img class="center-right" src="<?php echo IMG_PATH ?>/movingforward_webinar_28-04-21.png" alt="" style="right: -4vw !important;">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                        y="0px" viewBox="0 0 1000.17 1080">
                        <style type="text/css">
                ...
                <div class="left">
                    <h1 class="desc">
                        <!-- <?php echo translateTo('Subtítulo 1'); ?> -->
                        Moving Forward Webinars: Cidades em Transição
                            </h1>
                    <div class="line"></div>
                    <div class="desc2">
                        <!-- <?php echo translateTo('Texto 1'); ?> -->
                        No passado dia 28 de abril decorreu o 3º Moving Forward Webinar - Cidades em Transição. Para mais informações, clique no botão abaixo.
                    </div>
                    <div class="cta-cont">
                        <a href="https://www.v21.pt/noticias/moving-forward/3-moving-forward-webinar-2021-edition">
                            <div class="cta">
                                <div class="left">
            ...
            <div class="slide left" data-position='left' data-slide-id="2">
                <div class="bg">
                    <img class="center-left" style="left: 0vw;" src="<?php echo IMG_PATH ?>/v21-rural-estagio.jpg" alt="">
                    
                    <svg style="left: -.1%; transform: scaleX(-1);" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                        y="0px" viewBox="0 0 1000.17 1080">
                        <style type="text/css">
                        .cls1{fill:#fff;}.cls2{opacity:0.46;}.cls3{fill:#b6b8bd;}.cls4{fill:#f4f5fa;}.cls5{fill:#fddfdf;}
                        </style>
                ...
                <div class="left">
                    <!-- <h1 class="title"><?php echo translateTo('Título 2'); ?></h1> -->
                    <h1 class="desc">
                        <!-- <?php echo translateTo('Subtítulo 1'); ?> -->
                        Programa V21 Rural: Cooperação e estágio é a última fase do programa e conta com 12 participantes
                            </h1>
                    <div class="line"></div>
                    <div class="desc2">
                        <!-- <?php echo translateTo('Texto 1'); ?> -->
                        Uma iniciativa da Vissaium XXI e do Município de Viseu - o Programa V21 Rural - cria rede de apoio para ajudar empreendedores na implementação dos negócios
                    </div>
                    <div class="cta-cont">
                        <a href="https://www.v21.pt/noticias/v21-rural/programa-v21-rural-cooperacao-estagio">
                            <div class="cta">
                                <div class="left">
                                    <div class="txt"><?php echo translateTo('Saiba mais'); ?></div>
                                </div>
            ...
            <div class="slide right" data-position='right' data-slide-id="3">
                <div class="bg">
                    <img class="center-center" src="<?php echo IMG_PATH ?>/edificio-v21.jpg" alt="">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                        y="0px" viewBox="0 0 1000.17 1080">
                        <style type="text/css">
                            .st0{opacity:0.46;}
                ...
                <div class="left">
                    <!-- <h1 class="title"><?php echo translateTo('Título 3'); ?></h1> -->
                    <h1 class="desc">
                        <!-- <?php echo translateTo('Subtítulo 1'); ?> -->
                        V21 - Centro de Incubação Tecnológica de Viseu - concurso
                            </h1>
                    <div class="line"></div>
                    <div class="desc2">
                        <!-- <?php echo translateTo('Texto 1'); ?> -->
                        ...
                        Com o  objetivo de requalificação do edifício do V21 – Centro de Incubação Tecnológico de Viseu, está a decorrer o concurso público da Empreitada, bem como o  procedimento pré-contratual de consulta prévia  para a aquisição de serviços de Fiscalização e  Coordenação de Segurança, da mesma.
                        <br>
                        Os procedimentos de contratação  decorrem na plataforma <a href="www.acingov.pt" target="_target">www.acingov.pt</a>.
                        <br><br>
                        Muito em breve, iniciaremos  as obras de requalificação!

                    </div>
                    <div class="cta-cont">
                        <a href="https://www.v21.pt/noticias/noticias-gerais/v21-centro-de-incubacao-tecnologica-de-viseu-concurso">
                            <div class="cta">
                                <div class="left">
                                    <div class="txt"><?php echo translateTo('Saiba mais'); ?></div>
                                </div>
        ...
        <div class="indicators">
            <div class="ind active" onClick="currentSlide(1)">
            ...
            <div class="ind" onClick="currentSlide(2)">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512">
                    <g>
                        <path d="M479.1,129.2l-96.3-96.3c-15.3-16-36.7-24.4-58.8-24.4h-38.2l0.8,100.1
                            c81,16.8,132.9,95.5,116.1,176.5s-95.5,132.9-176.5,116.1c-81-16.8-132.9-95.5-116.1-176.5c12.2-58.1,58.1-103.9,116.1-116.1
            ...
            <div class="ind" onClick="currentSlide(3)">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512">
                    <g>
                        <path d="M479.1,129.2l-96.3-96.3c-15.3-16-36.7-24.4-58.8-24.4h-38.2l0.8,100.1
                            c81,16.8,132.9,95.5,116.1,176.5s-95.5,132.9-176.5,116.1c-81-16.8-132.9-95.5-116.1-176.5c12.2-58.1,58.1-103.9,116.1-116.1
