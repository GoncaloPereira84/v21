            ...
            <div id="inscricoes">
                <div class="cards">
                    <div class="card fixed">
                        <img class="lazyload" src="<?php echo IMG_PATH ?>/v21-inscricoes-bg.jpeg" alt="">
                        <div class="filter"></div>
                        <div class="cont">
                            <div class="title">Incubadora de Base Rural</div>
                            <div class="cta-cont">
                                <a href="/inscricoes/base-rural">
                                    <div class="cta">
                    ...
                    <div class="card fixed">
                        <img class="lazyload" src="<?php echo IMG_PATH ?>/bg-insc-v21.jpg" alt="">
                        <div class="filter"></div>
                        <div class="cont">
                            <div class="title">V21 Centro de Incubação Tecnológico de Viseu</div>
                            <div class="cta-cont">
                                <a href="/inscricoes/v21">
                                    <div class="cta">
                                        <div class="txt">Quero inscrever-me!</div>
                                    </div>
                                </a>
                ...
                <!-- <div class="cards">
                    <div class="card mutable">
                        <div class="cont">
                            <div class="left">
                                <div class="img">
                                    <img class="lazyload" src="<?php echo IMG_PATH ?>/img-insc-mutable.jpg" alt="">
                                </div>
                            </div>
                            <div class="right">
                                <div class="date">
                                    ...
                                    <div class="txt">14.09.2020 a 25.09.2020</div>
                                </div>
                                <div class="title">Oficina do Empreendedor</div>
                                <div class="desc">A 1ª edição da Oficina do Empreendedor, contou com 43 inscrições. (…)</div>
                                <div class="ctas">
                                    <div class="cta-left">
                                        <div class="cta">
                                            <div class="txt">+</div>
...
<?php 
    ...
    $name = $area == 'base-rural' ? 'Incubadora de Base Rural' : 'V21 Centro de Incubação Tecnológico de Viseu';
?>
    ...
    <div class="content-wrapper">
        <div class="area">
            <div id="form-inscricao">
                <form id="inscricao" data-form-name="<?php echo $name; ?>">
                    <!---->
                    ...
                    <div class="form-fields quarter end">
                        <div id="submit" class="cta-cont" data-form-name="<?php echo $name; ?>">
                            <div class="cta">
