                    ...
                    <div class="area">
                        <div class="line top">
                            <div class="column left">
                                ...
                                <div class="address">
                                    <span><strong>Edifício Vissaium XXI</strong></span>
                                    <span>40.652797,-7.906550</span>
                                    <span><strong>Incubadora de Base Rural São Pedro de France</strong></span>
                                    <span>40.692662, -7.788219</span>
                                </div>
                            </div>
                                ...
                                <div class="contacts">
                                    <div class="left">
                                        ...
                                        <div>
                                            ...
                                            <span>Rua Dr. Luís Nava 3500-846 Viseu</span>
                                        </div>
                                        <div>
                                            <span>
                                                <strong>
                                        ...
                                        <div>
                                            ...
                                            <span>
                                                Antiga escola 1º CEB de São Cristóvão
                                                <br>
                                                Estrada Municipal 585 3505-358
                                                <br>
                                                São Pedro de France
                                            </span>
                                        </div>
                                    ...
                                    <div class="right">
                                        <div>
                                            <span><strong><?php echo translateTo('Contatos'); ?></strong></span>
                                        </div>
                                        <div>
                                            ...
                                            <span><a href="mailto:geral@v21.pt">geral@v21.pt</a></span>
                                        </div>
                                        <div>
                                            ...
                                            <span><a href="tel:+351232436474">+351 232 436 474</a></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="line mid">
                            ...
                            <div class="links">
                                <a href="/politica-privacidade"><?php echo translateTo('Política de Privacidade'); ?></a>
                                <!-- <span>|</span>
                                <a href="/termos-condicoes"><?php echo translateTo('Termos e Condições'); ?></a> -->
                                <span>|</span>
                                <a href="https://www.livroreclamacoes.pt/inicio" target="_blank" rel="noreferrer"><?php echo translateTo('Livro de Reclamações'); ?></a>
                            </div>
                        ...
                        <div class="line bottom">
                            ...
                            <span><strong>POWERED BY <a href="https://www.twobecreative.pt" target="_blank" rel="noreferrer">TWOBE CREATIVE</a></strong></span>
    ...
    <?php
        ...
        if($area == 'programas-projetos'){
            echo '<script src="/js/testemunhos.js"></script>';
        }

        if($area == 'noticias' || isset($pathinfo[2])){
            echo '<script src="/js/gallery-slider.js"></script>';
        }

        if($area == 'atualidade'){ //change to 1 when online
            echo '<script src="/js/noticias-filter.js"></script>';
        }
